...
rootpath = 'D:\\Lorenzo Documents\\Lorenzo\\Research Documents\\2024 07 - EnvironmentalEpidemiology\\24 10 - Vulnerability Model\\24 10 - V1\\Set_up_II\\datasource\\'
...
indb = pd.read_csv(rootpath+'OHCA_'+geolevel+'_2016to2022.csv',low_memory=False)

indb['DATETIME'] = pd.to_datetime(indb['data'].str.strip(), format='%Y/%m/%d %H:%M:%S.%f')
